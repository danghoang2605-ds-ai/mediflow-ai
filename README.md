...
- **OCR ảnh chụp/scan hồ sơ** dùng Claude Vision — giải pháp tạm thời, độ
  chính xác phụ thuộc chất lượng ảnh và chữ viết tay, chưa phải giải pháp
  cuối cùng (kế hoạch chuyển sang VNPT SmartReader khi có token từ BTC).
